...
void setup() { 
  ...
  Serial.println("Preheating MQ135 for 10 seconds..."); 
...
void loop() { 
  ...
  int soilMoisturePercent = constrain(soilMoistureValue, WET_VALUE, 
DRY_VALUE); 
  // Map to percentage (reversed: 1023 = 0%, 0 = 100%) 
float soilMoisturePercentFloat = map(soilMoisturePercent, DRY_VALUE, 
WET_VALUE, 0, 10000) / 100.0; 
